"""
This module generates different number patterns based on user choice.
Options include ascending, descending, reverse (while loop),
and multiplication table.
"""


def main():
    """Take user input and display selected number pattern."""
